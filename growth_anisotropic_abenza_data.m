...
%% Initialize cells
load('../cell-profiles/abenza-yeast/actual/processed.mat'); % load the processed data from Rojas
rv = rvs{profile_num};
...
save(['../cell-profiles/abenza-yeast-', num2str(profile_num), '.mat'], ...
...
exportgraphics(gcf, ['media/anisotropic_growth_gamma_s_theta_abenza-yeast-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
xlabel("s");
ylabel("\gamma(s)");
exportgraphics(gcf, ['media/anisotropic_growth_gamma_abenza-yeast-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_growth_epsilon_abenza-yeast-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_strain_distribution_abenza-yeast-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
p.Color = 'black';
exportgraphics(gcf, ['media/anisotropic_monotonicity_abenza-yeast-1_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
pbaspect([1.7 1 1]);
exportgraphics(gcf, ['media/anisotropic_profile_overlaid_abenza-yeast-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
