...
% 2D plot - tip radius of curvature vs location of max extensibility
hold on;
p = plot(R0_h_nl_6 ./ RN_h_nl_6, gam_peaks_h_nl_6 ./ RN_h_nl_6, 'LineWidth', 1.2); % extensibility peaks - hyphoids
p.Marker = '.'; p.MarkerSize = 10;
p = plot(R0_h_nl_12 ./ RN_h_nl_12, ext_peaks_h_nl_12 ./ RN_h_nl_12, 'LineWidth', 1.2);
p.Marker = '.'; p.MarkerSize = 10;
p = plot(R0_h_nl_24 ./ RN_h_nl_24, ext_peaks_h_nl_24 ./ RN_h_nl_24, 'LineWidth', 1.2);
p.Marker = '.'; p.MarkerSize = 10;
% p = plot(ks_peaks_h_l_03_30 ./ RN_h_l_03_30, gam_peaks_h_l_03_30 ./ RN_h_l_03_30, 'LineWidth', 1.2);
% p.Marker = '.'; p.MarkerSize = 10;
% p = plot(ks_peaks_h_l_0_30 ./ RN_h_l_0_30, gam_peaks_h_l_0_30 ./ RN_h_l_0_30, 'LineWidth', 1.2);
...
ylim tight;
% ylim([0 0.67]);
l = legend('Nonlinear K_h = \mu_h = 2', 'Nonlinear K_h = \mu_h = 12', 'Nonlinear K_h = \mu_h = 24', ...
    'Location', 'northwest');
...
% daspect([1 1 1]);
% set(ax,'XTick',[], 'YTick', []);
exportgraphics(gcf, 'tip_shape_variety_r0_lp_extensibility.png', 'Resolution', 300);
close all;

% 2D plot - tip radius of curvature vs width of extensibility window
hold on;
p = plot(R0_h_nl_6 ./ RN_h_nl_6, W_ext_h_nl_6 ./ RN_h_nl_6, 'LineWidth', 1.2); % extensibility window - hyphoids
p.Marker = '.'; p.MarkerSize = 10;
p = plot(R0_h_nl_12 ./ RN_h_nl_12, W_ext_h_nl_12 ./ RN_h_nl_12, 'LineWidth', 1.2);
p.Marker = '.'; p.MarkerSize = 10;
p = plot(R0_h_nl_24 ./ RN_h_nl_24, W_ext_h_nl_24 ./ RN_h_nl_24, 'LineWidth', 1.2);
p.Marker = '.'; p.MarkerSize = 10;
...
set(get(get(h,'Annotation'),'LegendInformation'), ... % hack to not display legend entry for the divider
    'IconDisplayStyle','off');
exportgraphics(gcf, 'tip_shape_variety_r0_W_extensibility.png', 'Resolution', 300);
close all;
