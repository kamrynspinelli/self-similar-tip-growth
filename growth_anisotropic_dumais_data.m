...
save(['../cell-profiles/dumais-root-hair-', num2str(profile_num), '.mat'], ...
...
exportgraphics(gcf, ['media/anisotropic_growth_gamma_s_theta_dumais-root-hair-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
ax = gca;
set(ax, 'fontsize', 12);
exportgraphics(gcf, ['media/anisotropic_growth_gamma_dumais-root-hair-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_growth_epsilon_dumais-root-hair-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_strain_distribution_dumais-root-hair-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
p.Color = 'black';
exportgraphics(gcf, ['media/anisotropic_monotonicity_dumais-root-hair-1_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_profile_overlaid_dumais-root-hair-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
