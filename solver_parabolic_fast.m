...
% r_dot(1,end) = P/2*arcs(end-1).vert(2)-arcs(end-1).sigmaS*sin(lastMidptAlpha);% The tip is a cone, the boundary condition fixed, multiply by 10 to make it faster
