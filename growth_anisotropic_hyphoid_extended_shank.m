function [tip_length gam_peak ZN RN Rtip W_int gam L0Spline strainl ksspline] = growth_anisotropic_hyphoid_extended_shank(a,stiffness)
% clear all
time = cputime;
%% parameters
...
% find the y such that f(y) = -8, this will be the base of the cell
...
save(['hyphoid_extended_shank_a_', num2str(a), '_k_', num2str(stiffness), '_mu_', num2str(stiffness), '.mat'], ...
...
exportgraphics(gcf, ['media/anisotropic_growth_gamma_s_theta_hyphoid_extended_shank_a_', num2str(a), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
xlabel("s");
ylabel("\gamma(s)");
exportgraphics(gcf, ['media/anisotropic_growth_gamma_hyphoid_extended_shank_a_', num2str(a), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_strain_distribution_hyphoid_extended_shank_a_', num2str(a), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
p.Color = 'black';
exportgraphics(gcf, ['media/anisotropic_monotonicity_hyphoid_extended_shank_a_', num2str(a), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
pause(0.5);
exportgraphics(gcf, ['media/anisotropic_profile_overlaid_hyphoid_extended_shank_a_', num2str(a), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
ax.XRuler.TickLabelGapOffset = -20;
pause(0.5);
exportgraphics(gcf, ['media/anisotropic_profile_overlaid_strain_rates_hyphoid_extended_shank_a_', num2str(a), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
