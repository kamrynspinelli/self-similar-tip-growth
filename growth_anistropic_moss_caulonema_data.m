...
%% Initialize cells
load('../cell-profiles/moss/caulonema-data.mat'); % load the moss shape data
rv = rvs{profile_num};
X = rv(1,:);
Y = rv(2,:);
...
save(['../cell-profiles/moss-caulonema-', num2str(profile_num), '.mat'], ...
...
exportgraphics(gcf, ['media/anisotropic_growth_gamma_s_theta_moss-caulonema-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
ax = gca;
set(ax, 'fontsize', 12);
exportgraphics(gcf, ['media/anisotropic_growth_gamma_moss-caulonema-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_growth_epsilon_moss-caulonema-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_strain_distribution_moss-caulonema-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
p.Color = 'black';
exportgraphics(gcf, ['media/anisotropic_monotonicity_moss-caulonema-1_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_profile_overlaid_moss-caulonema-', num2str(profile_num), '_k_', num2str(k), '_mu_', num2str(mu), '.png']);
close all;
...
function profile_plots(Px, Py)
    ...
    daspect([1 1 1]);
    axis off;
    exportgraphics(gcf, 'media/moss-caulonema-profiles.png');
end