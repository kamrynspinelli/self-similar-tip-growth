function [tip_length gam_peak ZN RN Rtip W_int gam L0Spline strainl] = growth_anisotropic_ellipse(a, b, poisson, young)
% clear all
time = cputime;
%% parameters
...
tip_arclength_total = midpt(@(x) sqrt(1 + b^2 / a^2 * x.^2 ./ (a^2 - x.^2)), 0, a, 2048);
...
exportgraphics(gcf, ['media/anisotropic_growth_gamma_s_theta_ellipse_a_', num2str(a), '_b_', num2str(b), '_pois_', num2str(poisson), '_young_', num2str(young), '.png']);
close all;
...
xlabel("s");
ylabel("\gamma(s)");
exportgraphics(gcf, ['media/anisotropic_growth_gamma_ellipse_a_', num2str(a), '_b_', num2str(b), '_pois_', num2str(poisson), '_young_', num2str(young), '.png']);
close all;
...
exportgraphics(gcf, ['media/anisotropic_strain_distribution_ellipse_a_', num2str(a), '_b_', num2str(b), '_pois_', num2str(poisson), '_young_', num2str(young), '.png']);
close all;
...
p.Color = 'black';
exportgraphics(gcf, ['media/anisotropic_monotonicity_ellipse_a_', num2str(a), '_b_', num2str(b), '_pois_', num2str(poisson), '_young_', num2str(young), '.png']);
close all;
...
pause(0.5);
exportgraphics(gcf, ['media/anisotropic_profile_overlaid_ellipse_a_', num2str(a), '_b_', num2str(b), '_pois_', num2str(poisson), '_young_', num2str(young), '.png']);
close all;
