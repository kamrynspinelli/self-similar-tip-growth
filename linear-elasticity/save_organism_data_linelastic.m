clear all;
for prof = 1:10
    [tip_length gam_peak Z R Rtip W_int gam L0Spline strainl ksspline] = growth_anisotropic_dumais_data_linelastic(prof, 0.3, 30);
...
save('../../cell-profiles/dumais-geometry-and-secretion_pois_0.3_young_30.mat');
